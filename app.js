...
function certPrintHtml() {
  ...
  return '<!DOCTYPE html><html><head><meta charset="utf-8"><title>Certification & Expiry Report</title>' +
    ...
    '</style></head><body>' +
    '<div style="display:flex;align-items:center;gap:10px;margin-bottom:12px;border-bottom:2px solid #d97706;padding-bottom:8px"><img src="' + AF_LOGO + '" width="40" height="40" style="border-radius:9px" alt="U.S. AutoForce"><div style="font-size:10px;font-weight:bold;letter-spacing:1.8px;text-transform:uppercase;color:#d97706">U.S. AutoForce</div></div>' +
    '<div style="display:flex;align-items:center;gap:10px;margin-bottom:12px;border-bottom:2px solid #d97706;padding-bottom:8px"><img src="' + AF_LOGO + '" width="40" height="40" style="border-radius:9px" alt="U.S. AutoForce"><div style="font-size:10px;font-weight:bold;letter-spacing:1.8px;text-transform:uppercase;color:#d97706">U.S. AutoForce</div></div>' +
